...
{if(!bypass)
{if(Game.cookiesEarned>=1000000)Game.Win('Sacrifice');if(Game.cookiesEarned>=1)Game.Win('Oblivion');if(Game.cookiesEarned>=1000)Game.Win('From scratch');if(Game.cookiesEarned>=1000000)Game.Win('Nihilism');}
...
{var prestige=cookies/1000;prestige=Math.max(0,Math.floor((-1+Math.pow(1+8*prestige,0.5))/2));return prestige;}
...
var order=100;Game.moneyAchievs=['Wake and bake',1,'Making some dough',100,'So baked right now',1000,'Fledgling bakery',10000,'Affluent bakery',100000,'World-famous bakery',1000000,'Cosmic bakery',10000000,'Galactic bakery',100000000,'Universal bakery',1,'Timeless bakery',10,'Infinite bakery',100,'Immortal bakery',1000,'You can stop now',10000,'Cookies all the way down',100000,'Overdose',1000000,'How?',10000000];for(var i=0;i<Game.moneyAchievs.length/2;i++)
...
order=200;Game.cpsAchievs=['Casual baking',1,'Hardcore baking',10,'Steady tasty stream',100,'Cookie monster',1000,'Mass producer',10000,'Cookie vortex',1000000,'Cookie pulsar',10000000,'Cookie quasar',100000000,'A world filled with cookies',10,'Let\'s never bake again',1000];for(var i=0;i<Game.cpsAchievs.length/2;i++)
